    ...
    <div style={{ maxWidth: "860px" }}>
      ...
      <form action={updateArticle} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <div>
          ...
          <input name="excerpt" defaultValue={article.excerpt ?? ""} style={inputStyle} placeholder="Short description shown in article list" />
        </div>
        ...
        <div>
          ...
          <CoverImageUpload name="coverImage" initialUrl={article.coverImage ?? ""} />
        </div>
        ...
        <div>
          ...
          <ArticleEditor name="content" initialContent={article.content} />
        </div>

        <div style={{ display: "flex", gap: "12px", alignItems: "center", paddingTop: 8 }}>
      ...
      <div style={{ marginTop: "48px", paddingTop: "24px", borderTop: "1px solid rgba(0,0,0,0.08)" }}>
        <p style={{ fontSize: "13px", color: "#6b6b63", marginBottom: "12px", fontFamily: "DM Sans, sans-serif" }}>Danger zone</p>
        <form action={deleteArticle}>
          <input type="hidden" name="id" value={article.id} />
          <button
            type="submit"
            style={{ backgroundColor: "#E24B4A", color: "#fff", padding: "10px 20px", border: "none", borderRadius: "8px", fontSize: "14px", cursor: "pointer" }}
          >
            Delete Article
          </button>
        </form>
